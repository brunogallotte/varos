...
export function Footer() {
  return (
    <footer className="mx-auto max-w-9/10 pb-8 md:h-102 md:pb-0 lg:h-100 lg:max-w-9/10 xl:max-w-8xl">
      <div className="h-full justify-between gap-6 text-greyPaletteC1 lg:flex">
